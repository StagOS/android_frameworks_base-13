...
import com.android.systemui.StagSystemUIUtils;
...
import com.android.systemui.stag.NotificationLightsView;
...
import com.stag.internal.util.PowerUtils;
...
public class NotificationPanelViewController extends PanelViewController {
    ...
    public void reTickerView(boolean visibility) {
        if (!StagSystemUIUtils.settingStatusBoolean("reticker_status", mView.getContext())) return;
        ...
        if (visibility && getExpandedFraction() != 1) {
            ...
            if (StagSystemUIUtils.settingStatusBoolean("reticker_colored", mView.getContext())) {
                int col;
    ...
    private void reTickerViewVisibility() {
        if (!StagSystemUIUtils.settingStatusBoolean("reticker_status", mView.getContext())) {
            reTickerDismissal();
            return;
        }
